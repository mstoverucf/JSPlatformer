...
Player.prototype.act = function(step, level, keys) {
	...
	// Losing animation
	if (level.status == "lostLava") {
		this.pos.y += step*1.5;
		this.size.y -= step*1.5;
	}
	
	if (level.status == "lostSpike") {
		this.pos.y += step*1.5;
		this.size.x -= step*1.5;
	}
...
Level.prototype.playerTouched = function(type, actor) {
	...
	if (type == "spike1" && this.status == null || type == "spike2" && this.status == null) {
